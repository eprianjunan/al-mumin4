        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form
                        action="<?= base_url('guru/saveMateri/'. $idkelas['id_kelas']. '/' . $mapelid['id_mapel']); ?>"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="judul" placeholder="Judul"
                                            class="form-control">
                                        <small class="form-text text-muted">Tulislah Judul sesuai dengan
                                            Materi</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <?= form_open_multipart('guru/saveMateri/') ?>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="/guru/listmateri/<?=$idkelas['id_kelas']?>/<?= $mapelid['id_mapel']?>"
