                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-6">
                                        <label for="textarea-input" class=" form-control-label"><b>Start</b>
                                            <?= $i['tgl_buat']?></label>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-12 col-md-6">
                                        <label for="textarea-input" class=" form-control-label"><b>deadline</b>
                                            <?= $i['durasi']?></label>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-7">
                                        <iframe src=<?= base_url() ."/assets/tugas/" .$i["file"]; ?> height="700"
                                            width="750" title="Iframe Example"></iframe>
                                    </div>
                                </div>
