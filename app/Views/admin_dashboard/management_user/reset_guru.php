...
<div class="container-fluid">
    <div class="row">
        <div class="col-5">
            ...
            <form action="/guru/reset/<?= $akun['pengajar_id']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <input type="hidden" name="id" value="<?= $akun['id']; ?>">
                <input type="hidden" name="username" value="<?= $akun['username']; ?>">
                <div class="mb-3">
                    <label for="nama_guru" class="form-label">Nama Guru</label>
                    <input type="text" class="form-control" id="nama_guru" name="nama_guru" readonly value="<?= $guru['nama_guru']; ?>">
                </div>
